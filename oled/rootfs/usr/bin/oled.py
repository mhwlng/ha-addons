...
device = globals()[DISPLAY_TYPE](interface, rotate=DISPLAY_ROTATE, width=int(DISPLAY_WIDTH), height=int(DISPLAY_HEIGHT))
device.contrast(50)
...
#fnt = ImageFont.truetype("/usr/bin/pixelmix.ttf", 14)
#fnt = ImageFont.truetype("/usr/bin/miscfs_.ttf", 14)
